...
class _AdminNotificationsScreenState extends State<AdminNotificationsScreen> {
  ...
  String _target = 'ALL'; // ALL au VOTERS
  ...
  Future<void> _sendNotification() async {
    ...
    try {
      final result = await ApiService.sendBroadcastNotification({
      ...
      if (result.containsKey('message')) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Arifa imetumwa kwa mafanikio!', style: GoogleFonts.poppins()),
            backgroundColor: Colors.green,
            behavior: SnackBarBehavior.floating,
          ),
        );
      } else {
        throw Exception(result['error'] ?? 'Imeshindwa kutuma');
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Hitilafu: $e', style: GoogleFonts.poppins()),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Ujumbe utatokea kama arifa kwenye simu zao papo hapo.',
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Kichwa cha Habari (Title)',
                              hintText: 'Mfano: Matokeo yameshatoka!',
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: _targetOption('Wote', 'ALL', Icons.groups),
                              ),
                              const SizedBox(width: 12),
                              Expanded(
                                child: _targetOption('Voters Tu', 'VOTERS', Icons.how_to_vote),
                              ),
                            ],
                          ),
                        ],
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(
                          _isLoading ? 'Inatuma...' : 'TUMA ARIFA SASA',
