        ...
        builder: (context, electionSnap) {
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, ticketsSnap) {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Imeshindwa kupakia matokeo (hakuna ruhusa).',
              ...
              final election = electionDoc?.data();
              ...
              final totalVotes = _getTotalVotes(sortedTickets);
                        ...
                        children: [
                          ...
                          if (isActive)
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const Icon(Icons.stream, color: Colors.white70, size: 14),
                                const SizedBox(width: 4),
                                Text(
                                  'Matokeo yanafuatiliwa kwa muda halisi',
                                  style: GoogleFonts.poppins(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isActive
                  ? 'Matokeo yataonekana baada ya kura kupigwa'
                  : 'Uchaguzi umekwisha, matokeo yataonekana ukiwashwa kwenye mfumo.',
